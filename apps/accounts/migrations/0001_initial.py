    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('public', 'Public User'), ('fire_team', 'Fire Team Member'), ('admin', 'Administrator')], default='public', help_text='Type of user account', max_length=20)),
                ('badge_number', models.CharField(blank=True, help_text='Badge number for fire team members', max_length=50, null=True)),
                ('fire_station', models.CharField(blank=True, help_text='Assigned fire station for fire team members', max_length=255, null=True)),
